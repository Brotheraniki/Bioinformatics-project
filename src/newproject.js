            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-800">
                  CRISPR-Cas Off-Target Predictor (Demo)
                </h1>
                <p className="text-gray-600">
                  Educational simulation of a CRISPR off-target prediction UI
                  using toy scoring rules.
                </p>
              </div>
            </div>
            <span className="px-3 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800 border border-yellow-300">
              SIMULATION ONLY – NOT FOR LAB USE
            </span>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="euchromatin">Euchromatin (Active Genes)</option>
            ...
            >
              {loading ? (
                <>
                  ...
                  Running simulated model...
                </>
              ) : (
                <>
                  <TrendingUp className="w-5 h-5" />
                  Predict Off-Target Effects (Demo)
                </>
              )}
            </button>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
                ...
                Overall Risk Assessment (Toy Score)
              </h2>
              <div className="flex items-center gap-4">
                <div className="flex-1">
                  <div className="text-4xl font-bold mb-2">
                    <span className={riskColor(predictions.overallRisk)}>
                      {predictions.overallRisk.toFixed(2)}%
                    </span>
                  </div>
                  <p className="text-gray-600">
                    Simulated off-target probability (not experimentally
                    validated)
                  </p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
                ...
                Sequence & Chromatin Features (Toy Metrics)
              </h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {Object.entries(predictions.features).map(([key, value]) => (
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-semibold mb-4">
                Simulated Off-Target Sites (Top 10)
              </h2>
              <p className="text-sm text-gray-500 mb-3">
                These sites are randomly generated for demonstration and do not
                correspond to real genomic coordinates.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-semibold mb-4">
                Off-Target Score Distribution (Simulated)
              </h2>
              <ResponsiveContainer width="100%" height={300}>
                ...
                >
                  ...
                  <Scatter
                    ...
                    fill="#6366f1"
                    name="Off-Target Sites (simulated)"
                  />
                </ScatterChart>
              </ResponsiveContainer>
            </div>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-6 rounded">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800">
              ...
              <p className="mb-1">
                This application is an <strong>educational UI prototype</strong>{" "}
                for a CRISPR off-target prediction tool. The underlying scoring
                is a simple, hand-crafted toy model based on GC content and a
                simulated chromatin accessibility factor.
              </p>
              <p className="mb-1">
                It does <strong>not</strong> use real genomic data, real
                chromatin maps, or a trained machine learning model, and the
                “off-target sites” shown here do <strong>not</strong> correspond
                to actual positions in any genome.
              </p>
              <p className="font-semibold">
                Do not use these results for experimental design, clinical
                decisions, or safety assessment.
              </p>
            </div>
          </div>
        </div>
